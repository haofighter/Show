...
import com.myself.show.show.net.upload.entity.BaseEntity;
import com.myself.show.show.net.upload.exception.RetryWhenNetworkException;
import com.myself.show.show.net.upload.subscribers.ProgressSubscriber;
