package com.myself.show.show.View.picker.utils;

import android.os.Debug;
import android.os.Environment;
import android.util.Log;

import com.myself.show.show.base.AppConstant;
...
public final class LogUtils {
    ...
    private static boolean isDebug = AppConstant.DEBUG_ENABLE;// 是否调试模式
    private static String debugTag = AppConstant.DEBUG_TAG;// LogCat的标记
